    ...
    <div className="min-h-screen bg-kraft-light">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center space-x-2 text-sm text-gray-600 mb-8">
          <Link to="/" className="flex items-center space-x-1 hover:text-mush-purple">
            <ArrowLeft className="w-4 h-4" />
            <span>Voltar</span>
          </Link>
          <span>/</span>
          <span className="text-gray-900">{isLogin ? 'Login' : 'Cadastro'}</span>
        </div>
        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-purple-100">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-gray-900 mj-title mb-2">
                {isLogin ? 'Entrar na Mush Co.' : 'Criar conta na Mush Co.'}
              </h1>
              <p className="text-gray-600">
                {isLogin ? 'Acesse sua conta e continue suas compras' : 'Cadastre-se e aproveite nossas ofertas'}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {!isLogin && (
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-11 h-12 border-2 border-gray-200 focus:border-mush-purple"
                    required={!isLogin}
                  />
                </div>
              )}
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleInputChange}
                  className="pl-11 pr-11 h-12 border-2 border-gray-200 focus:border-mush-purple"
                  required
                />
                <button
                  type="button"
